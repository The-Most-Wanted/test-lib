  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 text-white py-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="animate-fade-in" style={{ animationDelay: '0.2s' }}>
            ...
            <ul className="space-y-4">
              <li>
                <Link to="/" className="font-inter text-gray-300 hover:text-yellow-400 transition-all duration-300 flex items-center group">
                  <span className="w-2 h-2 bg-yellow-400 rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  {t('home')}
                </Link>
              </li>
              <li>
                <Link to="/catalogue" className="font-inter text-gray-300 hover:text-yellow-400 transition-all duration-300 flex items-center group">
                  <span className="w-2 h-2 bg-yellow-400 rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  {t('catalogue')}
                </Link>
              </li>
              <li>
                <Link to="/contact" className="font-inter text-gray-300 hover:text-yellow-400 transition-all duration-300 flex items-center group">
                  <span className="w-2 h-2 bg-yellow-400 rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  {t('contact')}
                </Link>
              </li>
          ...
          <div className="animate-fade-in" style={{ animationDelay: '0.4s' }}>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3 font-inter text-gray-300 hover:text-yellow-400 transition-colors">
              ...
              <div className="flex items-start space-x-3 font-inter text-gray-300 hover:text-yellow-400 transition-colors">
        ...
        <div className="border-t border-gray-700/50 mt-12 pt-8 text-center animate-fade-in" style={{ animationDelay: '0.6s' }}>
