...
import { ArrowLeft, BookOpen, Calendar, Building, Mail, Sparkles, Eye, ShoppingCart, Star, Award } from "lucide-react";
...
const BookDetail = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50/30 to-red-50/50 font-inter">
        <Navigation />
        <div className="flex items-center justify-center min-h-[60vh] pt-20">
          <div className="text-center animate-fade-in">
            ...
            <h1 className="font-playfair text-2xl font-bold text-gray-900 mb-4">Chargement du livre...</h1>
          </div>
        </div>
        <Footer />
      </div>
        ...
        <div className="flex items-center justify-center min-h-[60vh] pt-20">
          <div className="text-center animate-fade-in">
            ...
            <button
              ...
              className="bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white px-8 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50/30 to-red-50/50 font-inter relative overflow-hidden">
      <Navigation />
      
      {/* Hero Section harmonisé */}
      <div className="relative z-10 bg-gradient-to-r from-amber-900 via-orange-900 to-red-900 text-white py-16 pt-24">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              <div className="aspect-[3/4] bg-gradient-to-br from-amber-100 to-orange-100 rounded-2xl shadow-2xl p-8 mx-auto max-w-sm">
                <div className="w-full h-full flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-24 h-24 bg-gradient-to-r from-amber-600 to-orange-600 rounded-full mx-auto mb-6 flex items-center justify-center shadow-lg">
                      <span className="text-white text-4xl font-playfair font-bold">
                        {(language === 'fr' ? book.title : book.title_en).charAt(0)}
                      </span>
                    </div>
                    <h3 className="text-amber-800 font-playfair font-bold text-xl leading-tight">
            ...
            <div className="animate-fade-in" style={{ animationDelay: '0.2s' }}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                <div className="bg-white/10 backdrop-blur-md rounded-lg p-4 text-center">
                  ...
                  <div className="text-sm text-orange-100">{t('publicationYear')}</div>
                  <div className="font-bold text-white">{book.year}</div>
                </div>
                <div className="bg-white/10 backdrop-blur-md rounded-lg p-4 text-center">
                  <BookOpen className="w-6 h-6 mx-auto mb-2 text-yellow-400" />
                  <div className="text-sm text-orange-100">{t('genre')}</div>
                ...
                <div className="bg-white/10 backdrop-blur-md rounded-lg p-4 text-center">
                  ...
                  <div className="text-sm text-orange-100">{t('publisher')}</div>
        ...
        {otherBooks.length > 0 && (
          <div className="animate-fade-in">
            <div className="flex items-center justify-between mb-8">
              ...
              <button
                onClick={() => navigate('/catalogue')}
                className="group bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {otherBooks.map((otherBook, index) => (
                <div
                  key={otherBook.id}
                  className="group bg-white/80 backdrop-blur-md rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 cursor-pointer border border-gray-100 animate-fade-in"
                  style={{ animationDelay: `${index * 0.1}s` }}
                  onClick={() => navigate(`/book/${otherBook.id}`)}
                >
                  <div className="aspect-[3/4] bg-gradient-to-br from-amber-100 to-orange-100 rounded-t-xl p-6">
                    <div className="w-full h-full flex items-center justify-center">
                      <div className="text-center">
                        <div className="w-16 h-16 bg-gradient-to-r from-amber-600 to-orange-600 rounded-full mx-auto mb-4 flex items-center justify-center group-hover:from-orange-600 group-hover:to-red-600 transition-all duration-300">
                          <span className="text-white text-2xl font-playfair font-bold">
                            {(language === 'fr' ? otherBook.title : otherBook.title_en).charAt(0)}
                          </span>
                        </div>
                        <h3 className="text-amber-800 font-playfair font-bold text-sm leading-tight px-2">
